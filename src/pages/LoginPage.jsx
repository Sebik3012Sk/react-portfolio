...
const LoginPage = () => {
  ...
  return (
    <div className="bg-slate-300 flex flex-col justify-center items-center content-center">
        ...
        <form onSubmit={loginSubmit} action={loginSubmitState ? window.location.assign("/") : console.error("Login Error")} className="bg-slate-500 w-max h-full m-16 p-16 rounded-2xl">
